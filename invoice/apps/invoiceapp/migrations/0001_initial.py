    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_type', models.CharField(choices=[('invoice', 'Invoice'), ('credit_note', 'Credit_note')], default='invoice', max_length=20)),
                ...
                ('is_credit_for', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='invoiceapp.invoice')),
