  ...
  <div class="page-edit-client">
    ...
    <nav class="breadcrumb" aria-label="breadcrumbs">
      <ul>
        ...
        <li><router-link :to="{ name: 'Client' }">{{ client.name }}</router-link></li>
        <li class="is-active"><router-link :to="{ name: 'EditClient' }" aria-current="true">Edit</router-link></li>
      </ul>
    </nav>
    ...
    <div class="columns is-multiline">
      ...
      <div class="column is-6">
        ...
        <div class="field">
          <label>Place</label>
          <div class="control">
            <input class="input" type="text" name="place" v-model="client.place" >
          </div>
        </div>
        <div class="field">
          <label>Country</label>
          <div class="control">
            <input class="input" type="text" name="country" v-model="client.country" >
          </div>
        </div>
      </div>
      <div class="column is-12">
