  ...
  <div class="page-invoice">
    ...
    <nav class="breadcrumb" aria-label="breadcrumbs">
      <ul>
        ...
        <li class="is-active"><router-link :to="{ name: 'Invoice' }" aria-current="true">{{ invoice.invoice_number }}</router-link></li>
      </ul>
    </nav>
    ...
    <div class="columns is-multiline">
      <div class="column is-12">
        ...
        <div class="buttons">
          <button class="button is-dark" @click="getPdf()">Download PDF</button>
          <button class="button is-success" @click="setAsPaid()" v-if="!invoice.is_paid">Set as paid</button>
        </div>
      </div>
